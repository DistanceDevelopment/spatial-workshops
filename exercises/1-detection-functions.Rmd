---
title: 'Exercise 1 solutions: Detection function analysis'
...
- $p_i$ are the probabilities of detection, we can obtain them using `predict(df_hn$ddf)`.
...
```{r save-models}
save(df_hn, # add you models here, followed by commas!
     distdata,
