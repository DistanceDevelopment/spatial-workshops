...
Here is a "solution" for practical 4. As with any data analysis, there is no correct answer, but this shows how I would approach this analysis. The analysis here is conditional on selecting a detection function and DSM in the previous exercises; I've chosen `df_hn` and `dsm_nb_xy` (see previous exercise for why).
