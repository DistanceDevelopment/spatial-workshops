---
title: 'Practical 2 solutions: Simple density surface models'
...
Here is a "solution" for practical 2. As with any data analysis, there is no correct answer, but this shows how I would approach this analysis. The analysis here is conditional on selecting a detection function in the previous exercises; I've chosen `df_hn` and `df_hr_ss_size` that we saved previously (see detection function solutions).
